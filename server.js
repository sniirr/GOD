...
var user_1 = require("./models/db/user");
...
app.get('/google/callback', passport.authenticate('google', {
    ...
    var user, userJWT, userDB, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = req.user;
                user.role = 'public';
                userJWT = jwt.encode(user, JWT_SECRET);
                userDB = new user_1["default"]({ name: 'Tal', last_entered: new Date() });
